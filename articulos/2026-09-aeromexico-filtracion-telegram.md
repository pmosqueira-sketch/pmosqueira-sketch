...
| **18 sep 2026** | Un usuario de Telegram ofrece una base de **más de 15 millones de registros (1.10 GB)** "presuntamente atribuible" a Aeroméxico. La firma de ciberseguridad SILIKN atribuye la venta al actor conocido como **"Eternal"** y la vincula con el robo de ShinyHunters de 2025. |
...
- Xataka México / Fortuna y Poder — atribución de SILIKN al actor "Eternal".
